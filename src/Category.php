...
class Category {
	...
	private $error      = "";
	//错误信息
	private $icon       = ['&emsp;&emsp;&emsp;&emsp;│', '&emsp;&emsp;&emsp;&emsp;├ ', '&emsp;&emsp;&emsp;&emsp;└ '];
	//格式化的字符
	private $fields     = [];
	...
	private function _searchList($cid = 0, $space = "") {
		...
		for ($i = 0; $i < $n; $i++) {
			...
			$this->_searchList($childs[$i][$this->fields['cid']], $space . "&emsp;&emsp;&emsp;&emsp;");
			// p($space);
